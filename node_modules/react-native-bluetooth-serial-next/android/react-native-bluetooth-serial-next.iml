...
<module external.linked.project.id=":react-native-bluetooth-serial-next" external.linked.project.path="$MODULE_DIR$" external.root.project.path="$MODULE_DIR$/../../../android" external.system.id="GRADLE" type="JAVA_MODULE" version="4">
  ...
  <component name="NewModuleRootManager" LANGUAGE_LEVEL="JDK_1_7">
    ...
    <orderEntry type="library" name="Gradle: __local_aars__:/Users/bbaktaeho/Desktop/testChairApp/node_modules/react-native-bluetooth-serial-next/android/libs/btsdk.jar:unspecified@jar" level="project" />
    ...
    <orderEntry type="library" name="Gradle: com.facebook.react:react-native:0.57.0@aar" level="project" />
